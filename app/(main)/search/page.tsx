    ...
    <main className="flex-1 min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Find people, posts, and content</p>
        </div>
                      ...
                      >
                        ...
                        <div className="flex items-start gap-3 mb-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-1.5 flex-wrap">
                              ...
                              <span className="text-[15px] text-muted-foreground leading-5">·</span>
                        ...
                        >
                          ...
                          >
                            ...
                            <span className="text-[13px]">{formatNumber(post.commentsCount)}</span>
                          </Button>
                          <Button
                            variant="ghost"
                            size="sm"
                          ...
                          >
                            ...
                            />
                            <span className="text-[13px]">{formatNumber(post.likesCount)}</span>
                          </Button>
                          <Button
                            variant="ghost"
                            size="sm"
